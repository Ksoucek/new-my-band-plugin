...
<body>
    ...
    <form method="POST">
        ...
        <div class="form-actions">
            ...
            <?php if ($kseft_id) : ?>
                <a href="<?php echo add_query_arg('delete_kseft_id', $kseft_id, site_url('/manage-kseft')); ?>" class="button" onclick="return confirm('Opravdu chcete smazat tento kšeft?');">Smazat Kšeft</a>
            <?php endif; ?>
        </div>
    </form>
    <?php wp_footer(); ?>
